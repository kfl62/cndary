...
CND_ROOT = File.expand_path('../',File.dirname(__FILE__))
CND_ENV  = ENV['RACK_ENV'] || 'development'
# Load our dependencies
require 'rubygems' unless defined?(Gem)
require 'bundler/setup'
require 'ostruct'
require 'yaml'
Bundler.require(:default, CND_ENV)
...
I18n.load_path += Dir.glob(File.join(CND_ROOT, 'system','i18n','**','*.yml'))
I18n.enforce_available_locales = false
I18n.default_locale = :ro
I18n.fallbacks[:ro]=[:ro,:en]
# Sintra default settings
Sinatra::Base.set(:root, CND_ROOT)
